...
export default function DashboardStudio() {
  ...
  const toolRoutes: Record<ToolType, string> = {
    image_generation: '/dashboard/images',
    video_generation: '/dashboard/video',
    code_generation: '/dashboard/code',
    ai_chat: '/dashboard/ai',
    agent_builder: '/dashboard/agents',
    app_builder: '/dashboard/apps',
    website_builder: '/dashboard/websites',
    text_editor: '/dashboard/ai', // Pour l'instant, rediriger vers AI chat
  };
