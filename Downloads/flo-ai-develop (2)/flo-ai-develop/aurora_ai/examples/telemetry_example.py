"""
Example demonstrating OpenTelemetry integration with aurora_ai
...
4. Track workflow execution in aurora
...
def setup_telemetry():
    ...
    """
    configure_telemetry(
        service_name='aurora_ai_example',
...
# Example 3: Workflow with aurora
async def example_workflow(llm):
    """
    Demonstrates workflow telemetry with aurora.
