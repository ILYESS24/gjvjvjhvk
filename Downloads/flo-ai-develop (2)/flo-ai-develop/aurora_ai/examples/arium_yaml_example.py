"""
Example demonstrating YAML-based aurora workflow construction.
...
from aurora_ai.aurora.memory import MessageMemoryItem
from aurora_ai.models import UserMessage
...
async def run_simple_example():
    ...
    builder = auroraBuilder.from_yaml(yaml_str=SIMPLE_WORKFLOW_YAML)
...
async def run_mixed_config_example():
    ...
    builder = auroraBuilder.from_yaml(yaml_str=MIXED_CONFIG_YAML)
