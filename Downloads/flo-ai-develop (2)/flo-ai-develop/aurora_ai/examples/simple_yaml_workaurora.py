...
async def main():
    ...
    try:
        # Create tools dictionary (required format for auroraBuilder)
        tools = {'web_search': web_search_tool}

        # Create aurora builder from YAML
        builder = auroraBuilder.from_yaml(yaml_str=workflow_yaml, tools=tools)
