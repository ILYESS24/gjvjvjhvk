...
from aurora_ai.models import DocumentMessageContent, TextMessageContent, UserMessage
...
from aurora_ai.llm import OpenAI, Gemini
...
async def example_2_document_workflow():
    ...
    try:
        ...
        workflow = auroraBuilder().from_yaml(yaml_str=workflow_yaml).build()
...
async def main():
    ...
    try:
        ...
        print('   • Integration with existing aurora workflows')
