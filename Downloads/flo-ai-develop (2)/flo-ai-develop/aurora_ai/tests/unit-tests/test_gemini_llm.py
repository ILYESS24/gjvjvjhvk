...
# Add the aurora_ai directory to the path
...
class TestGemini:
    ...
    @patch('aurora_ai.llm.gemini_llm.genai.Client')
    ...
    @pytest.mark.asyncio
    @patch('aurora_ai.llm.gemini_llm.types.GenerateContentConfig')
    ...
    @pytest.mark.asyncio
    @patch('aurora_ai.llm.gemini_llm.types.Tool')
    @patch('aurora_ai.llm.gemini_llm.types.GenerateContentConfig')
    ...
    def test_gemini_generation_config_creation(self):
        ...
        with patch('aurora_ai.llm.gemini_llm.types.GenerateContentConfig') as mock_config:
