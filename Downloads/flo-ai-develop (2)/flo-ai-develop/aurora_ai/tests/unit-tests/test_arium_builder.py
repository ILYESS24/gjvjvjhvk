"""
Basic tests for the auroraBuilder to ensure it works correctly.
"""

import pytest
from unittest.mock import Mock
from aurora_ai.aurora.builder import auroraBuilder, create_aurora
...
class TestauroraBuilder:
    def test_builder_initialization(self):
        ...
        assert builder._aurora is None

    def test_create_aurora_convenience_function(self):
        """Test the create_aurora convenience function"""
        builder = create_aurora()
        assert isinstance(builder, auroraBuilder)
...
if __name__ == '__main__':
    # Run a simple test
    test_builder = TestauroraBuilder()
