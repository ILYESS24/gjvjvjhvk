"""
Tests for YAML-based aurora workflow construction.
"""
...
from aurora_ai.aurora.memory import MessageMemory, BaseMemory
from aurora_ai.models.agent import Agent
from aurora_ai.llm import OpenAI


class TestauroraYamlBuilder:
    """Test class for YAML-based aurora builder functionality."""
    ...
    def test_from_yaml_validation_both_params(self):
        ...
        with pytest.raises(
            ...
            auroraBuilder.from_yaml(yaml_str='test', yaml_file='test.yaml')

    def test_from_yaml_validation_missing_aurora_section(self):
        """Test that from_yaml fails when YAML doesn't contain aurora section."""
        yaml_config = """
        metadata:
          name: test
        """
        with pytest.raises(ValueError, match='YAML must contain an "aurora" section'):
            auroraBuilder.from_yaml(yaml_str=yaml_config)
    ...
    def test_from_yaml_simple_configuration(self):
        ...
        with patch('aurora_ai.aurora.builder.AgentBuilder') as mock_agent_builder:
            ...
            builder = auroraBuilder.from_yaml(yaml_str=yaml_config)
    ...
    def test_from_yaml_with_custom_memory(self):
        ...
        with patch('aurora_ai.aurora.builder.AgentBuilder') as mock_agent_builder:
            ...
            builder = auroraBuilder.from_yaml(yaml_str=yaml_config, memory=custom_memory)
    ...
    def test_from_yaml_with_function_nodes(self):
        ...
        with patch('aurora_ai.aurora.builder.AgentBuilder') as mock_agent_builder:
            ...
            builder = auroraBuilder.from_yaml(
    ...
    def test_from_yaml_with_routers(self):
        ...
        with patch('aurora_ai.aurora.builder.AgentBuilder') as mock_agent_builder:
            ...
            builder = auroraBuilder.from_yaml(yaml_str=yaml_config, routers=routers)
    ...
    def test_from_yaml_missing_function_in_registry_error(self):
        ...
        with patch('aurora_ai.aurora.builder.AgentBuilder'):
            with pytest.raises(
                ValueError,
                match='Function missing_function not found in provided function_registry dictionary',
            ):
                auroraBuilder.from_yaml(yaml_str=yaml_config, function_registry={})
    ...
    def test_from_yaml_missing_router_error(self):
        ...
        with patch('aurora_ai.aurora.builder.AgentBuilder'):
            with pytest.raises(
                ...
                auroraBuilder.from_yaml(yaml_str=yaml_config, routers={})
    ...
    def test_from_yaml_with_base_llm(self):
        ...
        with patch('aurora_ai.aurora.builder.AgentBuilder') as mock_agent_builder:
            ...
            auroraBuilder.from_yaml(yaml_str=yaml_config, base_llm=mock_llm)
    ...
    def test_from_yaml_direct_agent_configuration(self):
        ...
        with patch('aurora_ai.llm.OpenAI') as mock_openai:
            mock_llm = Mock()
    ...
    def test_from_yaml_direct_config_with_parser(self):
        ...
        with patch('aurora_ai.llm.OpenAI') as mock_openai:
            with patch(
                'aurora_ai.formatter.yaml_format_parser.FloYamlParser'
            ) as mock_parser:
                mock_llm = Mock()
                mock_openai.return_value = mock_llm
    ...
    def test_from_yaml_direct_config_validation_errors(self):
        ...
        with pytest.raises(ValueError, match='Agent test_agent must have either'):
            auroraBuilder.from_yaml(yaml_str=yaml_config_missing_job)
        ...
        with patch('aurora_ai.llm.OpenAI'):
            with pytest.raises(ValueError, match='Invalid reasoning pattern'):
                auroraBuilder.from_yaml(yaml_str=yaml_config_invalid_pattern)
        ...
        with pytest.raises(ValueError, match='Model must be specified'):
            auroraBuilder.from_yaml(yaml_str=yaml_config_missing_model)
    ...
    def test_from_yaml_direct_config_with_base_llm(self):
        ...
        builder = auroraBuilder.from_yaml(yaml_str=yaml_config, base_llm=mock_base_llm)
    ...
    def test_from_yaml_prebuilt_agents(self):
        ...
        builder = auroraBuilder.from_yaml(yaml_str=yaml_config, agents=prebuilt_agents)
    ...
    def test_from_yaml_prebuilt_agents_missing_error(self):
        ...
        with pytest.raises(
            ...
            auroraBuilder.from_yaml(yaml_str=yaml_config, agents={})
